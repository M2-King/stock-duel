  ...
  return (
    <header className="header">
      ...
      <div className="header-right">
        ...
        <div className="profile-wrap" ref={popoverRef}>
          <button
          ...
          >
            ...
            <svg className={`profile-chevron ${popoverOpen ? 'open' : ''}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
